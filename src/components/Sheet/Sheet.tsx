...
export const SHEET_PRESETS_NICE_NAMES = {
  herma5051: 'HERMA 5051',
  herma5051_brotherHL3152CDW: 'HERMA 5051 (Brother HL-3152CDW adjusted)',
  herma5076: 'HERMA 5076',
  herma5076_brotherHL3152CDW: 'HERMA 5076 (Brother HL-3152CDW adjusted)',
};
...
export const SHEET_PRESETS: { [name in keyof typeof SHEET_PRESETS_NICE_NAMES]: SheetConfig } = {
  herma5051: {
    ...
    rows: 11,
    bodyPaddingTop: 8.8,
    bodyPaddingRight: 8.4,
    bodyPaddingBottom: 8.8,
    bodyPaddingLeft: 8.4,
    cellHorizontalGap: 0,
    cellVerticalGap: 0,
    cellWidth: 48.3,
    cellHeight: 25.4,
    cellBaseFontSizePx: 14,
    cellContentGap: 2,
    cellPaddingTop: 3,
    cellPaddingRight: 3,
    cellPaddingBottom: 3,
  ...
  herma5051_brotherHL3152CDW: {
    columns: 4,
    rows: 11,
    bodyPaddingTop: 8.8 + 2,
    bodyPaddingRight: 8.4,
    bodyPaddingBottom: 8.8 - 2,
    bodyPaddingLeft: 8.4,
    cellHorizontalGap: 0,
    cellVerticalGap: 0,
    cellWidth: 48.3,
  ...
  herma5076_brotherHL3152CDW: {
    columns: 2,
    rows: 7,
    bodyPaddingTop: 15.15 + 3.25,
    bodyPaddingRight: 4.67,
    bodyPaddingBottom: 15.15 - 3.25,
    bodyPaddingLeft: 4.67,
    cellHorizontalGap: 2.54,
    cellVerticalGap: 0,
    cellWidth: 99.06,
